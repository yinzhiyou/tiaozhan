...
public class PromoterClzTsActivity extends BaseActivity {
    ...
    protected void initUIAndListener() {
        ...
        zanwu_c = findViewById(R.id.zanwu_c);
        listView = findViewById(R.id.promo_clz_list);
        listView.setMode(PullToRefreshBase.Mode.BOTH);
        biaoti.setText("处理中投诉活动");
        spUtils = new SPUtils();
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                       ...
                       final  PromoterComplainthdlistEntity entity = gson.fromJson(result, PromoterComplainthdlistEntity.class);
                            zanwu_c.setVisibility(View.GONE);
...
//                                listView.setAdapter(adapter);
                            ...
                            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                    if (entity.getData().get(position-1).getReserve()==1){
                                        ...
                                        intent.setClass(PromoterClzTsActivity.this, ReserveCGDetailsActivity.class);
                                        ...
                                        intent.setClass(PromoterClzTsActivity.this, PromoterXQActivity.class);

                                        bundle.putString("uuid",data.get(position-1).getPublicUUid());
                                        bundle.putString("tag","1");
                                        bundle.putString("isHandle","2");
                                        intent.putExtras(bundle);
                            ...
                            if(EmptyUtils.isListEmpty(data)){
                                ...
                                zanwu_c.setVisibility(View.VISIBLE);
                            }
                            ...
                            Toast.makeText(PromoterClzTsActivity.this, entity.getMsg(), Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent();
