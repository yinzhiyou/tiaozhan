...
//    public static ChuangguanActivity instance = null;
    ...
    private LinearLayout sou, cgkong_layout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cgkong_layout = findViewById(R.id.cgkong_layout);
...
//                        .city(chengshi.getText().toString()));
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 202 && resultCode == RESULT_OK) {
            ...
            sousuo.setText("");
            chengshi.setText(nameCS);
            String souTag = data.getStringExtra("CityTag");
        ...
        listView
                .setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
                    ...
                    public void onPullDownToRefresh(
                        ...
                        LogU.Ld("1608", "下啦" + page + mylat + "===" + mylong + "错误码" + locType);
...
//                        }, 1000);
    ...
    private void init(String mLatitude, String mLongitude, String city, String area, final int page) {
        LogU.Ld("1608", "场馆信息" + mLatitude + "===" + mLatitude + "纬度" + mLongitude + "====" + mylong + "city" + city + "area" + area + "page" + page);
        OkHttpUtils
                .get()
...
//                            listView.setAdapter(adapter);
                            if (list.size() == 0) {
                                cgkong_layout.setVisibility(View.VISIBLE);
                            } else {
                                cgkong_layout.setVisibility(View.GONE);
                            ...
                            if (newList.size() == 0) {
                                ...
                                listViewXiala.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                    ...
                                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                        ...
                                        LogU.Ld("1608", "定1位" + mLatitude + "定2位" + mLongitude + "====" + city);
...
//                mBaiduMap.clear();
                mLatitude = mylat;
                mLongitude = mylong;
                LogU.Ld("1608", "定3位" + mLatitude + "定4位" + mylat + "====" + mylong);
                LogU.Ld("1608", "定3位" + mLatitude + "定4位" + mLongitude);
                init(mylat + "", mylong + "", city, area, 1);
                tag = 1;
                break;
...
//                mBaiduMap.clear();
        mLatitude = mylat;
        mLongitude = mylong;
        LogU.Ld("1608", "定5位" + mLatitude + "定6位" + mylat + "===" + mylong + "===" + mLongitude + "===" + city + "===" + chengshi.getText().toString());
        init(mLatitude + "", mLongitude + "", chengshi.getText().toString(), area, 1);
        tag = 1;
    }
