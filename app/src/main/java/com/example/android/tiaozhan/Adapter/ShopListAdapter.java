...
import com.example.android.tiaozhan.Home.TianjiaDizhiActivity;
...
public class ShopListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.jiage.setText(list.get(position).getCost()+"对手币");
        viewHolder.shichangjiage.setText("¥"+String.format("%.2f", list.get(position).getPrice()));
        viewHolder.shichangjiage.getPaint().setFlags(Paint. STRIKE_THRU_TEXT_FLAG|Paint.ANTI_ALIAS_FLAG);
