...
public class LoopViewLV extends View {
    ...
    private LoopViewGestureListenerLV simpleOnGestureListener;
    Context context;
    Paint paintA;
    Paint paintB;
    Paint paintC;
    ...
    public LoopViewLV(Context context) {
        super(context);
        initLoopView(context);
    }

    public LoopViewLV(Context context, AttributeSet attributeset) {
        super(context, attributeset);
        initLoopView(context);
    }

    public LoopViewLV(Context context, AttributeSet attributeset, int i1) {
    ...
    private void initLoopView(Context context) {
        ...
        z = 0.0F;
        totalScrollY = 0;
        simpleOnGestureListener = new LoopViewGestureListenerLV(this);
        handler = new MessageHandlerLV(this);
        this.context = context;
        setTextSize(16F);
    }

    static int getSelectItem(LoopViewLV loopview) {
        return loopview.getCurrentItem();
    }

    static void b(LoopViewLV loopview) {
        loopview.f();
    }
    ...
    private void f() {
        ...
        mTimer = timer;
        timer.schedule(new MTimerLV(this, i1, timer), 0L, 10L);
    }
    ...
    protected final void b(float f1) {
        Timer timer = new Timer();
        mTimer = timer;
        timer.schedule(new LoopTimerTaskLV(this, f1, timer), 0L, 20L);
    }

    protected final void b(int i1) {
        Timer timer = new Timer();
        mTimer = timer;
        timer.schedule(new MyTimerTaskLV(this, i1, timer), 0L, 20L);
    }

    protected final void c() {
        if (loopListener != null) {
            (new Handler()).postDelayed(new LoopRunnableLV(this), 200L);
        }
    }
