...
public class HDXQEntity {
    ...
    public static class DataBean {
        ...
        private String getRefereeComplainIssystem;
        ...
        public String getLeveexplain() {
            return Leveexplain;
        }

        public void setLeveexplain(String leveexplain) {
            Leveexplain = leveexplain;
        }

        public int getZyUser() {
            return zyUser;
        }

        public void setZyUser(int zyUser) {
            this.zyUser = zyUser;
        }

        public int getZyUsers() {
            return zyUsers;
        }

        public void setZyUsers(int zyUsers) {
            this.zyUsers = zyUsers;
        }

        public int getZyUserss() {
            return zyUserss;
        }

        public void setZyUserss(int zyUserss) {
            this.zyUserss = zyUserss;
        }
        ...
        public String getGetRefereeComplainIssystem() {
            return getRefereeComplainIssystem;
        }

        public void setGetRefereeComplainIssystem(String getRefereeComplainIssystem) {
            this.getRefereeComplainIssystem = getRefereeComplainIssystem;
        }

        public String getRefereeisHandle() {
            return RefereeisHandle;
        }

        public void setRefereeisHandle(String refereeisHandle) {
            RefereeisHandle = refereeisHandle;
        }

        public String getRefereeComplaint() {
            return RefereeComplaint;
        }

        public void setRefereeComplaint(String refereeComplaint) {
            RefereeComplaint = refereeComplaint;
        }
        ...
        public void setRefereecomplaintistrue(String refereecomplaintistrue) {
            Refereecomplaintistrue = refereecomplaintistrue;
        }
        ...
        public void setRefereedetailed(String refereedetailed) {
            Refereedetailed = refereedetailed;
        }
        ...
        public List<AdrawBuserInfoBean> getAdrawBuserInfo() {
            return AdrawBuserInfo;
        }

        public void setAdrawBuserInfo(List<AdrawBuserInfoBean> adrawBuserInfo) {
            AdrawBuserInfo = adrawBuserInfo;
        }

        public List<SignUserInfoBean> getSignUserInfo() {
            return SignUserInfo;
        }

        public void setSignUserInfo(List<SignUserInfoBean> signUserInfo) {
            SignUserInfo = signUserInfo;
        }

        public List<NotSignUserInfoBean> getNotSignUserInfo() {
            return notSignUserInfo;
        }

        public void setNotSignUserInfo(List<NotSignUserInfoBean> notSignUserInfo) {
        ...
        private double refereeFee;

        private int end;

        private int SparrComplaint;

        private String ComplaintsResult;
        ...
        public String getComplaintsResult() {
            return ComplaintsResult;
        }

        public void setComplaintsResult(String complaintsResult) {
            ComplaintsResult = complaintsResult;
        }

        public int getSparrComplaint() {
            return SparrComplaint;
        }

        public void setSparrComplaint(int sparrComplaint) {
            SparrComplaint = sparrComplaint;
        }
        ...
        public double getRefereeFee() {
            return refereeFee;
        }

        public void setRefereeFee(double refereeFee) {
        ...
        public List<GetRefereeResultBean> getGetRefereeResult() {
            return getRefereeResult;
        }

        public void setGetRefereeResult(List<GetRefereeResultBean> getRefereeResult) {
            this.getRefereeResult = getRefereeResult;
        }

        private List<GetRefereeResultBean> getRefereeResult;
        ...
        public static class TeamABean {
            ...
            public int getIsSignIns() {
                return isSignIns;
            }

            public void setIsSignIns(int isSignIns) {
                this.isSignIns = isSignIns;
            }
        ...
        public static class GetRefereeResultBean {
            /**
             * referee : C1
             * playerimg : uploads/HeaderImgs/2020-02-07/20200207172634794.png
             * result : 1
             */
