...
public class AyingBAdapter extends BaseAdapter {

    private Context context;
    private List<HDXQEntity.DataBean.AwinBuserInfoBean> list;
    public AyingBAdapter (Context context, List<HDXQEntity.DataBean.AwinBuserInfoBean> list){
