...
public  abstract  class BaseRecycleAdapter  <T> extends RecyclerView.Adapter<BaseRecycleAdapter.BaseViewHolder>{
    ...
    protected List<GreenDao> datas;
    protected Context mContext;

    public BaseRecycleAdapter(List<GreenDao> datas,Context mContext) {
        this.datas = datas;
     ...
     * @param datas
     */
    public void refresh(List<GreenDao> datas){
        this.datas.clear();
     ...
     * @param data
     */
    public   void updata(List<GreenDao> data){
        this.datas=data;
        notifyDataSetChanged();
    }
     ...
     * @param datas
     */
    public void addData(List<GreenDao> datas){
        this.datas.addAll(datas);
        notifyDataSetChanged();
    }
    /**
    ...
    public void setRvItemDataOnclickListener(RvItemDataOnclickListener rvDataItemOnclickListener) {
        mRvDataItemOnclickListener = rvDataItemOnclickListener;
    }

    protected     RvItemDataOnclickListener mRvDataItemOnclickListener;


    public interface  RvItemDataOnclickListener{

        void RvItemDataOnclick(int position);
    }
