...
public class FQLVPickerDialog extends Dialog {
    private FQLVPickerDialog.Params params;

    public FQLVPickerDialog(Context context, int themeResId) {
        super(context, themeResId);
    }

    private void setParams(FQLVPickerDialog.Params params) {
        this.params = params;
    }
    ...
    public static class Builder {
        ...
        private final FQLVPickerDialog.Params params;

        public Builder(Context context) {
            this.context = context;
            params = new FQLVPickerDialog.Params();
        }
        ...
        public FQLVPickerDialog.Builder setData(List<String> dataList, List<String> dataList2) {
        ...
        public FQLVPickerDialog.Builder setTitle(String title) {
            params.title = title;
            return this;
        }

        public FQLVPickerDialog.Builder setUnit(String unit) {
            params.unit = unit;
            return this;
        }

        public FQLVPickerDialog.Builder setSelection(int selection,int selection2) {
            params.initSelection = selection;
            params.initSelection2 = selection2;
            return this;
        }

        public FQLVPickerDialog.Builder setOnDataSelectedListener(OnDataSelectedListener onDataSelectedListener) {
            params.callback = onDataSelectedListener;
            return this;
        }


        public FQLVPickerDialog create() {
            final FQLVPickerDialog dialog = new FQLVPickerDialog(context, params.shadow ? R.style.Theme_Light_NoTitle_Dialog : R.style.Theme_Light_NoTitle_NoShadow_Dialog);
            View view = LayoutInflater.from(context).inflate(R.layout.layout_falv_picker, null);
