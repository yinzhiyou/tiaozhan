...
public class SelectResereeLVDialog extends BaseDialog {
     ...
     * @param mContext
     */
    public SelectResereeLVDialog(Context mContext,OnClickListener listener) {
    ...
    private void create() {
        ...
        wheel.setWheelStyle(WheelStyle.STYLE_RESEREE_LV);
