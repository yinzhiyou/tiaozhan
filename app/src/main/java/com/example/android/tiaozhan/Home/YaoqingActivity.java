...
public class YaoqingActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private String token,mylat,mylng,teamSex = "2",minlevel="1",maxlevel = "10",sportName = "all",city,area,type="myfriend",sportid = "1",
            team ="1",tab,FirstSportId,SecondSportId,uuid,Agemax,Agemin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StatusBarUtil.setColor(YaoqingActivity.this,getResources().getColor(R.color.white),0);
        ...
        if (tab.equals("1")){
          ...
          //  listB = bundle.getStringArrayList("listTXB");
            FQTZEntity listF = (FQTZEntity) bundle.getSerializable("listF");
            teamSex =  bundle.getString("teamSex");
            minlevel =  bundle.getString("minlevel");
       ...
       /* for(int i = 0;i<listA.size();i++){
            ...
            adapter = new YaoqingAdapter(this,data,tab,this,FirstSportId);

          //  adapter = new YaoqingAdapter(this,data,tab,this,listA,listB,FirstSportId);
...
//        http://192.168.0.203/tzOne/public/index.php/api/register?mobile=13321112517&password=wwwwww&password_confirmation=wwwwww&code=944952
        ...
        OkHttpUtils
                ...
                .addParams("type",type)
                .addParams("sportid",FirstSportId)
...
//验证发布和加入的条件
    private void getCondition(String type, final int page) {
//        http://192.168.0.203/tzOne/public/index.php/api/register?mobile=13321112517&password=wwwwww&password_confirmation=wwwwww&code=944952
        LogU.Ld("1608", "邀请好友--" + token+"city--"+city+"area--"+area+"mylat--"+mylat+"mylng--"+mylng+"type--"+type+"sportid--"+sportid+"teamSex--"+teamSex
                +"minlevel--"+minlevel+"maxlevel--"+maxlevel+"team--"+team);
        OkHttpUtils
