...
//
    ...
    //修改信息
    private void initYD(String yundong) {
        LogU.Ld("1608", "修改信息" + token);
        OkHttpUtils
                .post()
                .url(getResources().getString(R.string.http_xutils_zpf_al_cs) + "/FaveriteSportSave")
                .addHeader("token", token)
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        if (a) {
                          ...
                          //  mlist = xiuGaiSportAdapter.getSelectList();
                            ...
                            MultiCheckHelper multiCheckHelper=new MultiCheckHelper(recyclerView);
