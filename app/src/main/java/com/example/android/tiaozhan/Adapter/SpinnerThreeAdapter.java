...
public class SpinnerThreeAdapter extends BaseAdapter {
    private List<AQWentiEnditu.DataBean.ThreeQuestionBean> list;
    private Context mContext;

    public SpinnerThreeAdapter(Context pContext, List<AQWentiEnditu.DataBean.ThreeQuestionBean> list) {
