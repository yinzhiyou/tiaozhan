...
public abstract class SpinerPopWindow<T> extends PopupWindow {
    ...
    public SpinerPopWindow(Context context, List<T> list, int resId,View.OnClickListener itemsOnClick){
        this.mContext=context;
        this.datas = list;
        mInflater = LayoutInflater.from(mContext);
        this.itemResId=resId;
        mActivity= (Activity) context;
        initPopup(mActivity,itemsOnClick);
    }

    /**
     * 初始化PopupWindow
     */
    private void initPopup(final Activity context,View.OnClickListener itemsOnClick){
