...
//        } else {
        holder = new LabelHolder(LayoutInflater.from(context).inflate(R.layout.adapter_sport_item_cg, null));
//        }
...
//    }
    ...
    private class LabelHolder extends RecyclerView.ViewHolder {
        ...
        public LabelHolder(View inflate) {
            super(inflate);
            textView = (TextView) inflate.findViewById(R.id.textViewContent_sp);
