package com.example.android.tiaozhan.Toos.zhifu;
...
public class PayFragment extends DialogFragment implements View.OnClickListener {
    ...
    private void initView(Dialog dialog) {
        ...
        dialog.findViewById(R.id.wangjimima).setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.wangjimima:
                ...
                intent.setClass(getContext(), MyTXMMActivity.class);
