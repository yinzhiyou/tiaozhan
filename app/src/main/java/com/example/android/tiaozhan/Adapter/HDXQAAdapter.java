...
public class HDXQAAdapter extends BaseAdapter {
    private Context context;
    private List<HDXQEntity.DataBean.TeamABean> list;
    private int s;
    private String tag;
    private SPUtils spUtils;
    private String token, bieming, moshiString, zhuangtaiString, uid;

    public HDXQAAdapter(Context context1, List<HDXQEntity.DataBean.TeamABean> list, int s, String tag, String moshiString,
            ...
            if (list.get(position).getIsQuit() == 2) {
                ...
                if (list.get(position).getIsSignIn() == 1) {
                    ...
                    if (zhuangtaiString.equals("4")) {
                        ...
                        //zhuangtaiString.equals("2") || zhuangtaiString.equals("3")
                    } else if (zhuangtaiString.equals("2") || zhuangtaiString.equals("3") || zhuangtaiString.equals("1")||zhuangtaiString.equals("9")) {
...
//                    viewHolder.yaoqingzhong.setVisibility(View.GONE);
                       /* if (list.get(position).getIsPublisher()==1){
                        ...
                        if (list.get(position).getIsSeat() == 1) {
                            ...
                            } else if (!uid.equals(list.get(position).getInvitedByPlayerUUID()) && list.get(position).getResult() != -1) {
                                viewHolder.yaoqingzhong.setVisibility(View.VISIBLE);
        ...
        //  LogU.Ld("1608", "是不是发布者" + list.get(position).getIsPublisher());
    ...
    public class ViewHolder {
        ...
        private TextView lv, lv2, no, yaoqingzhong;
