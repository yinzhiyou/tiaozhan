...
public class HDXQCPAdapter extends BaseAdapter {
    ...
    public HDXQCPAdapter(Context context1, List<HDXQEntity.DataBean.TeamCBean> list, int s, String tag, String moshiString,
    ...
    @Override
    public int getCount() {
        //     LogU.Ld("1608", "1适配B队人数" + s+tag+moshiString+zhuangtaiString);
        return s;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.hdxq_cp_grid, parent, false);
...
//            viewHolder.yaoqingzhong.setVisibility(View.VISIBLE);
                ...
                viewHolder.yaoqingzhong.setText("迟到");
                    ...
                    if (list.get(position).getIsSignIn() == 1) {
                        ...
                        if (zhuangtaiString.equals("4")) {
                            ...
                            if (list.get(position).getIsConfirmResult() == 0) {
                                ...
                                if (list.get(position).getIsQuitInGame() == 2) {
                                    viewHolder.yaoqingzhong.setVisibility(View.VISIBLE);
                                    viewHolder.yaoqingzhong.setText("中途退出");
                                } else if (list.get(position).getIsQuit() == 2) {
                                    viewHolder.yaoqingzhong.setText("提前退出");
                                    viewHolder.yaoqingzhong.setVisibility(View.VISIBLE);
                                } else if (list.get(position).getIsSignIns() == 2) {
                                    viewHolder.yaoqingzhong.setVisibility(View.VISIBLE);
                        ...
                        if (zhuangtaiString.equals("1")) {
                            ...
                            if (list.get(position).getIsSignIns() == 3){
                                viewHolder.yaoqingzhong.setVisibility(View.VISIBLE);
                                viewHolder.yaoqingzhong.setText("未签到");
                            }else {
                                viewHolder.yaoqingzhong.setVisibility(View.GONE);
        ...
        if (tag.equals("1")) {
            viewHolder.touxiang.setImageDrawable(context.getResources().getDrawable(R.mipmap.icon_touxiang_wu));
        } else {
