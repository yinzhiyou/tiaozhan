...
public class StartTimeActivity extends BaseActivity implements OnDateSelectedListener, View.OnClickListener {
    ...
    private String token, invitedId, fqtzXiangmudaid, fqtzXiangmuid, cgid, hezuo, fqtzXiangmu, cgname, wcgid, wcgname;
    private String wfqtzXiangmudaid, wfqtzXiangmuid;
    //    private int tag =1 ;
...
//        zuihou = findViewById(R.id.start_time_zuihou);
        ...
        LogU.Ld("1609", "运1动" + yId + "=========" + cgid + "====" + fqtzXiangmudaid + "===" + fqtzXiangmuid);

        yId = bundle.getString("yId");
        cgid= bundle.getString("uid");
        wcgid= bundle.getString("wuid");
        if (yId.equals("2")) {
           cgid = bundle.getString("cgid");

            fqtzXiangmudaid = bundle.getString("fqtzXiangmudaid");
            fqtzXiangmuid = bundle.getString("fqtzXiangmuid");
            LogU.Ld("1609", "运==动" + yId + "=========" + cgid + "====" + fqtzXiangmudaid + "===" + fqtzXiangmuid);
            ...
            LogU.Ld("1609", "运wcgid动" + yId + "=========" + cgid + "====" + fqtzXiangmudaid + "===" + fqtzXiangmuid);
        ...
        wcgname = (String) spUtileFQTZ.get(this, "wcgname", " ");
        ...
        wfqtzXiangmudaid = (String) spUtileFQTZ.get(this, "wfqtzXiangmudasportId", "无");
        wfqtzXiangmuid = (String) spUtileFQTZ.get(this, "wfqtzXiangmusportId", "无");
        ...
        LogU.Ld("1609", "运动" + yId + "=========" + wcgid + "====" + wfqtzXiangmudaid + "===" + wfqtzXiangmuid);
        LogU.Ld("1609", "运动" + yId + "=========" + wcgname + "====" + cgname + "===" + wfqtzXiangmuid);

        if (yId.equals("1")) {
            web.loadUrl("https://venue.zhaoduishou.com/#/appOrder" + "?siteuid=" + wcgid + "&sportid=" + wfqtzXiangmudaid + "&token=" + token + "&sporttype=" + wfqtzXiangmuid);

        } else if (yId.equals("2")) {
            web.loadUrl("https://venue.zhaoduishou.com/#/appOrder" + "?siteuid=" + cgid + "&sportid=" + fqtzXiangmudaid + "&token=" + token + "&sporttype=" + fqtzXiangmuid);
...
//                            }
    ...
    private void TimeYesorNo() {
        http:
//192.168.0.203/tzOne/public/index.php/api/register?mobile=13321112517&password=wwwwww&password_confirmation=wwwwww&code=944952
...
//                            }
    ...
    public class AndroidJs {
        ...
        public void goTime(String obj) {
            ...
            if (!EmptyUtils.isEmpty(obj)) {
                ...
                LogU.Ld("1608", "点我了时间" + obj + "瞎传" + obj.toString());
                String placeDate = entity.getPlaceDate();

                String time1 = getTime(placeDate);
                String strTime = getStrTime(time1);
                String substr = strTime.substring(6, 11);


                //  LogU.Le("1608","点我了时间"+strtodate+"==="+date);
                ...
                intent.setClass(StartTimeActivity.this, FaqiTiaozhanActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                intent.putExtra("datayu", substr + substring);
                intent.putExtra("dataa", placeDate + " " + substring);
                ...
                spUtileFQTZ.put(StartTimeActivity.this, "cgname2", cgname);
                spUtileFQTZ.put(StartTimeActivity.this, "hezuo2", hezuo);
                if (yId.equals("1")) {
                    intent.putExtra("ydId", 1 + "");
                    //  intent.putExtra("wdatayu",substr+substring);
                    //   intent.putExtra("wdataa",placeDate+" "+substring);
                    //  intent.putExtra("wplaceTimeLen",entity.getPlaceTimeLen());
                    //  intent.putExtra("wplaceNun",entity.getPlaceNun());
                    // intent.putExtra("wplaceMoney",placeMoney+"");
                    intent.putExtra("wcgname", cgname + "");
                    ...
                    // intent.putExtra("placeNun",entity.getPlaceNun());
                    // intent.putExtra("placeMoney",placeMoney+"");
                    intent.putExtra("zcgname", cgname + "");
                    spUtils.remove(StartTimeActivity.this, "yId");
                }
    ...
    public class AndroidStartTime {
        ...
        public void startTime(String urll) {
            urll = "https://venue.zhaoduishou.com/#/appOrder" + "?siteuid=" + cgid + "&sportid=" + fqtzXiangmudaid + "&token=" + token + "&sporttype=" + fqtzXiangmuid;
