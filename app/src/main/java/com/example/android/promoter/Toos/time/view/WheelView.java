package com.example.android.promoter.Toos.time.view;
...
import com.example.android.promoter.Toos.time.util.SizeConvertUtil;
...
public class WheelView extends View {
    ...
    private void init(Context context) {
        ...
        mPaint.setColor(getResources().getColor(R.color.text_content));
        ...
        selectPaint.setColor(getResources().getColor(R.color.text_title));
        ...
        centerLinePaint.setColor(getResources().getColor(R.color.text_content));
