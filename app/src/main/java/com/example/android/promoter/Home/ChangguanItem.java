...
public class ChangguanItem extends BaseActivity {
    ...
    public int initContentView() {
        return R.layout.activity_changguan_item;
    }

    @Override
    protected void initUIAndListener() {
        biaoti = findViewById(R.id.biaoti);
        time = findViewById(R.id.changguan_item_time);
        neirong = findViewById(R.id.changguan_item_neirong);
