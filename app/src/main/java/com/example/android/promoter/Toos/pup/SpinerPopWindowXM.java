package com.example.android.promoter.Toos.pup;
...
public abstract class SpinerPopWindowXM<T,L> extends PopupWindow {
    ...
    public SpinerPopWindowXM(Context context, List<T> list, List<L> datastwo,int resId) {
    ...
    private void initPopup() {
        View view = mInflater.inflate(R.layout.spiner_window_layout_xm, null);
        setContentView(view);
        //设置PopupWindow宽高
        ...
        recyclerView_right.setLayoutManager(new LinearLayoutManager(mContext));
        //设置adapter
        spinerAdapter = new SpinerAdapter(mContext, datas, itemResId);
        recyclerView.setAdapter(spinerAdapter);
        spinerAdapter2 = new SpinerAdapter(mContext,  datas, itemResId);
            ...
            if (mItemClickListener != null) {
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        recyclerView_right.setAdapter(spinerAdapter2);
