...
import com.example.android.promoter.Toos.time.view.WheelStyle;
import com.example.android.promoter.Toos.time.view.WheelView;

public class SelectLVDialog extends BaseDialog{
     ...
     * @param mContext
     */
    public SelectLVDialog(Context mContext, OnClickListener listener) {
    ...
    private void create() {
        ...
        TextView tz =(TextView) dialogView.findViewById(R.id.xz_text);
        tz.setText("技术等级");
