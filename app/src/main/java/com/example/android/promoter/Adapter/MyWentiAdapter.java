...
import com.example.android.promoter.Entity.MyWentiEntity;
import com.example.android.promoter.R;

import java.util.List;

public class MyWentiAdapter extends BaseAdapter {
    private List<MyWentiEntity.DataBean> list;
    private Context mContext;

    public MyWentiAdapter(Context pContext, List<MyWentiEntity.DataBean> list) {
