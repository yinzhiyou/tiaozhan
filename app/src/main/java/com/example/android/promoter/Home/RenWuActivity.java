...
import com.example.android.promoter.My.JBMXActivity;
...
public class RenWuActivity extends BaseActivity implements View.OnClickListener {
    ...
    private RelativeLayout fenxian1, fenxiang2, qufabu, quxinzeng, qugenggai, fabujingcai, qiandaoLayout;
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        if (a) {
                            ...
                            jinbi.setText("通用金币" +  df.format(entity.getData().getCoins()) + "个");
