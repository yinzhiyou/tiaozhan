...
//                Log.d("1608",  message.getStringAttribute("avatar", null)+"揍1"+message.getStringAttribute("nickname", null));
//            } else {
//                Log.d("1608",  message.getStringAttribute("avatar", null)+"揍2"+message.getStringAttribute("nickname", null)+message.getFrom());
//                EaseUserUtils.setUserAvatar(context, message.getStringAttribute("avatar",null), userAvatarView);
//                EaseUserUtils.setUserNick( message.getStringAttribute("nickname", null), usernickView);
//            }

            if(message.direct() == Direct.SEND){
                Glide.with(context).load("http://app.tiaozhanmeiyitian.com/"+message.getStringAttribute("avatar", null)).into(userAvatarView);
//                usernickView.setText(message.getStringAttribute("nickname",""));
//                try {
//                    EaseUserUtils.setUserNick(message.getStringAttribute("nicheng"), usernickView);
...
//                usernickView.setText(message.getStringAttribute("to_nickname",""));
//                usernickView.setText("ssssss");
//                titleBar.setTitle("aaaa");
//                titleBar.setRightImageResource(R.drawable.ease_mm_title_remove);
        ...
        if (itemStyle != null) {
            ...
            if (usernickView != null) {
                Log.d("1608","显示"+itemStyle.isShowUserNick());
