...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    private String token,touxiang,nickname,uuid,hytouxiang,hynickname;
...
//
//        titleBar.setTitle((String) spUtils.get(getContext(), "haoyouname", "aaaaa"));
//        titleBar.setTitle( (String) spUtils.get(getContext(), "nickname", " "));
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {
            // set title
            if (getUserInfo(toChatUsername) != null) {
                EaseUser user = getUserInfo(toChatUsername);
                if (user != null) {
    ...
    protected void sendMessage(EMMessage message) {
        ...
        touxiang = (String) spUtils.get(getContext(), "touxiang", " ");
        nickname = (String) spUtils.get(getContext(), "nickname", " ");
        hytouxiang = (String) spUtils.get(getContext(), "haoyoutouxiang", " ");
        hynickname = (String) spUtils.get(getContext(), "haoyouname", " ");
        Log.d("1608","我啥都不是"+nickname+"&"+hynickname+touxiang+"&"+hytouxiang);
        message.setAttribute("nickname", nickname);
        message.setAttribute("avatar", touxiang);
//        message.setAttribute("nickname", nickname+"&"+hynickname);
//        message.setAttribute("avatar", touxiang+"&"+hytouxiang);
        message.setMessageStatusCallback(messageStatusCallback);
